...
# Estilos visuales para que la interfaz se vea pro
st.markdown("""
    <style>
...
# 2. Enlace de exportación directo en formato CSV (Gid=0 es la primera pestaña)
...
def cargar_datos():
    # Leemos el CSV directo de la URL pública
    return pd.read_csv(GOOGLE_SHEETS_URL, header=None)
...
try:
    ...
    st.error("🔄 Conectando con la base de datos de Google Sheets... Si el mensaje persiste, recarga la página.")